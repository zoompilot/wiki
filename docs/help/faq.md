...
how the steering behaves. The 2022-25 CX-5 EPS — the electric power
steering motor — steers to zero (all the way down to a stop) and is the
recommended motor for [alpha longitudinal](../features/alpha-longitudinal.md). It is factory-fitted in the
CX-5 2022–2025, and an older Mazda gets it by swapping the motor in —
the CX-9 included. Every other car runs on its stock motor's limits.
See [Will it work on my car?](../getting-started/supported-cars.md).
