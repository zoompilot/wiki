...
<svg viewBox="0 0 800 190" role="img" aria-label="The cruise arbiter picks the setpoint owner per car class: pcm-op-long cars run openpilot and SLA in plannerd, ICBM cars let the stock ECU step on button presses, and op-long cars without pcmCruise run openpilot's v_cruise">
  ...
  <rect class="d-box-accent" x="290" y="14" width="220" height="44"/>
  <text class="d-hi" x="400" y="32" text-anchor="middle">cruise arbiter</text>
  <text x="400" y="48" text-anchor="middle">sessions · press classification</text>
  <path class="d-flow" d="M400,58 V78 H145 V96"/>
  <path class="d-flow-accent" d="M400,58 V96"/>
  <path class="d-flow" d="M400,58 V78 H655 V96"/>
  <rect class="d-box-accent" x="30" y="100" width="230" height="66"/>
  <text class="d-hi" x="145" y="120" text-anchor="middle">pcm-op-long</text>
  <text x="145" y="137" text-anchor="middle">openpilot steps the set speed</text>
  <text x="145" y="153" text-anchor="middle">SLA session in plannerd</text>
  <rect class="d-box-accent" x="285" y="100" width="230" height="66"/>
  <text class="d-hi" x="400" y="120" text-anchor="middle">ICBM</text>
  <text x="400" y="137" text-anchor="middle">stock ECU steps on presses</text>
  <text x="400" y="153" text-anchor="middle">SLA mirrored in card</text>
  <rect class="d-box" x="540" y="100" width="230" height="66"/>
  <text class="d-hi" x="655" y="120" text-anchor="middle">op-long, no pcmCruise</text>
  <text x="655" y="137" text-anchor="middle">openpilot v_cruise steps</text>
  <text x="655" y="153" text-anchor="middle">mirrored in card</text>
</svg>
</div>
