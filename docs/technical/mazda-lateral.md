...
<div class="diagram">
<svg viewBox="0 0 800 150" role="img" aria-label="The zoompilot steering path: camera to controller to EPS to wheels, with the EPS report feeding back at 100 Hz">
  <defs>
  ...
  <rect class="d-box-stock" x="16" y="45" width="120" height="44"/>
  <text class="d-hi" x="76" y="63" text-anchor="middle">camera</text>
  <text x="76" y="78" text-anchor="middle">driver model</text>
  <rect class="d-box-accent" x="210" y="45" width="180" height="44"/>
  <text class="d-hi" x="300" y="63" text-anchor="middle">zoompilot lateral</text>
  <text x="300" y="78" text-anchor="middle">STEER_STEP · 100 Hz</text>
  <rect class="d-box" x="470" y="45" width="150" height="44"/>
  <text class="d-hi" x="545" y="63" text-anchor="middle">Mazda EPS</text>
  <text x="545" y="78" text-anchor="middle">12 counts / 10 ms</text>
  <rect class="d-box" x="700" y="45" width="84" height="44"/>
  <text class="d-hi" x="742" y="71" text-anchor="middle">wheels</text>
  <line class="d-flow" x1="136" y1="67" x2="206" y2="67"/>
  <text x="171" y="38" text-anchor="middle">CAM_LKAS</text>
  <line class="d-flow-accent" x1="390" y1="67" x2="466" y2="67"/>
  <text x="428" y="38" text-anchor="middle">LKAS_REQUEST</text>
  <line class="d-flow" x1="620" y1="67" x2="696" y2="67"/>
  <text x="658" y="38" text-anchor="middle">torque</text>
  <path class="d-flow-accent" d="M545,89 V124 H300 V93"/>
  <text x="422" y="117" text-anchor="middle">0x241 · LKAS_EFFECTIVE · 100 Hz</text>
</svg>
</div>
