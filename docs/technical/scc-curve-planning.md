...
<div class="diagram">
<svg viewBox="0 0 800 250" role="img" aria-label="A curve region on the path ahead, and the speed profile below it: cruise speed, a ramp down before the region, a low flat through it, and a ramp back after">
  <defs>
  ...
  <text x="20" y="34">path ahead</text>
  <rect class="d-box-accent" x="400" y="18" width="160" height="52"/>
  <text class="d-hi" x="480" y="48" text-anchor="middle">curve region</text>
  <line class="d-lane" x1="400" y1="74" x2="400" y2="118"/>
  <line class="d-lane" x1="560" y1="74" x2="560" y2="118"/>
  <text x="20" y="146">speed</text>
  <line class="d-line-axis" x1="110" y1="230" x2="770" y2="230"/>
  <text x="770" y="246" text-anchor="end">distance</text>
  <path class="d-ceiling" d="M280,150 H400 V205 H560 V150"/>
  <text x="480" y="142" text-anchor="middle">curvature ceiling</text>
  <path class="d-flow-accent" d="M120,150 H280 C330,150 360,205 430,205 H550 C610,205 640,150 700,150 H760"/>
  <text x="150" y="138" text-anchor="middle">cruise speed</text>
</svg>
</div>
